...
\usepackage[orientation=portrait,size=custom,width=11.05,height=9.0]{beamerposter}
...
%	\end{columns}
	...
	\begin{textblock}{5.5}(0.1,0.)
		%\fcolorbox{black}{boxcol}{%
			\begin{minipage}{\textwidth}
			\includegraphics[width=\textwidth,trim=0 0 15 0,clip=True]{TSDensityplot.pdf}
			\end{minipage}
		%}
	\end{textblock}%
%\centering
